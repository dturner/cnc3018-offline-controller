...
extern FileChooser fileChooser;
    ...
    void GrblDRO::begin() {
        ...
        menuItems.push_back( MenuItem::simpleItem(6, "Bed forward", [](MenuItem&){  
            GCodeDevice::getDevice()->scheduleCommand("G53 G0 Y0"); 
        }) );
        menuItems.push_back( MenuItem::simpleItem(7, "Bed backward", [](MenuItem&){  
            GCodeDevice::getDevice()->scheduleCommand("G53 G0 Y-175"); 
        }) );
        menuItems.push_back( MenuItem::simpleItem(8, "Set XYZ to 0", [](MenuItem&){  
            GCodeDevice::getDevice()->scheduleCommand("G10 L20 P1 X0Y0Z0"); 
        }) );
        menuItems.push_back( MenuItem::simpleItem(9, "Set XY to 0", [](MenuItem&){  
            GCodeDevice::getDevice()->scheduleCommand("G10 L20 P1 X0Y0"); 
        }) );
        menuItems.push_back( MenuItem::simpleItem(10, "Goto XY=0", [](MenuItem&){  
            GCodeDevice::getDevice()->scheduleCommand("G0 X0Y0"); 
        }) );
        menuItems.push_back( MenuItem::simpleItem(11, "Machine/Work", [this](MenuItem&){ 
            useWCS=!useWCS; 
